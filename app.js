...
if(dotenv.error){
    ...
    let configs = ['DOMAIN', 'ADDRESS', 'INDEX', 'NAME', 'ABOUT', 'HELP', 'GIVE', 'PEERHTTPURL', 'PEERWSURL', 'STARTUPDOWNLOAD', 'RANDOM', 'PORT', 'LIMITCONNECTIONS', 'SECUREDOMAIN', 'SECURESERVER', 'CERTFILE', 'CERTKEY', 'PROXY', 'HEARTBEAT'];
